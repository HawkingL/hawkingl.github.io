...
tags: 项目文档
categories: 后端
descriptions: 新建 `api_server` 文件夹作为项目根目录，并在项目根目录中运行如下的命令，初始化包管理配置文件：
top_img: "https://hawking-img.oss-cn-hangzhou.aliyuncs.com/BlogPic/v2-4f12e142cc3c0451243ee229647e0b04_1440w.jpg"
cover: "https://hawking-img.oss-cn-hangzhou.aliyuncs.com/BlogPic/v2-8f9bd0565ca081cf9ea266f3497e724a_r.jpg"
abbrlink: 21abc880
date: 2022-02-01 12:56:54
---

## Headline

> 大事件后台 API 项目，API 接口文档请参考 https://www.showdoc.com.cn/hawkingL/8845195311102189
...
1. 在 `my_db_01` 数据库中，新建 `ev_users` 表如下：
   ![ev_users表结构](D:\BaiduNetdiskDownload\images\1.jpg)
...
![文章分类表结构](D:\BaiduNetdiskDownload\images\2.jpg)

#### 4.1.2 新增两条初始数据

![文章分类表结构](D:\BaiduNetdiskDownload\images\3.jpg)
...
![ev_articles表结构](D:\BaiduNetdiskDownload\images\4.jpg)
