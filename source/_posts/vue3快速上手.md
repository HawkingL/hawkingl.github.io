...
categories: 前端
keywords: Vue3
description: Vue3学习笔记，从Vue2过渡到Vue3，相比于Vue2，Vue3更加“轻”，秉持用多少给多少的理念。
...
<div style="border:1px solid black;width:300px;float:left;margin-right:20px;"><strong>vue2.x的生命周期</strong><img src="https://cn.vuejs.org/images/lifecycle.png" alt="lifecycle_2" style="zoom:33%;width:1200px" /></div><div style="border:1px solid black;width:510px;height:985px;float:left"><strong>vue3.0的生命周期</strong><img src="https://v3.cn.vuejs.org/images/lifecycle.svg" alt="lifecycle_2" style="zoom:33%;width:2000px" /></div>
